...
public class DisplayHealthcare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.display_healthcare);

        // List of Healthcare Businesses
        listView = (ListView) findViewById(R.id.healthcare_list);
        listView.setBackgroundColor(getResources().getColor(R.color.lightPurple));
        listView.bringToFront();

        // Menu
        menu_lv = findViewById(R.id.menu_lv);
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(DisplayHealthcare.this,
        ...
        menu_lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    case 0:
                        startActivity(new Intent(DisplayHealthcare.this, MainActivity.class));
                        break;
                    case 1:
                        startActivity(new Intent(DisplayHealthcare.this, Categories.class));
                        break;
                    case 3:
                        startActivity(new Intent (DisplayHealthcare.this, ViewCard.class));
                        break;
                }
            }
        });
        ...
        // Call to getHealthcare.php
        // IP string stored in app/res/values/strings.xml
        downloadJSON("http://" + getResources().getString(R.string.IP) +"/" + getResources().getString(R.string.AppFolder)+ "/getHealthcare.php");
    }
    ...
    */
    private void display_info(String json, int position, ListView lv) throws JSONException{
        // Begin by setting the transparency for the healthcare list and the banner to invisible
        // Display the details in separate layout
        lv.setAlpha(0);
        lv.setEnabled(false);
        ConstraintLayout HealthcareBanner = findViewById(R.id.healthcareBanner);
        HealthcareBanner.setAlpha(.2f);
        ...
        closeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ListView lv = findViewById(R.id.healthcare_list);
                lv.setAlpha(1);
                lv.setEnabled(true);

                ConstraintLayout HealthcareBanner = findViewById(R.id.healthcareBanner);
                HealthcareBanner.setAlpha(1);
                ConstraintLayout DetailsLayout = findViewById(R.id.details);
