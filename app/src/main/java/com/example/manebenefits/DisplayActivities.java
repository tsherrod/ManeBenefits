...
public class DisplayActivities extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        menu_lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    case 0:
                        startActivity(new Intent(DisplayActivities.this, MainActivity.class));
                        break;
                    case 1:
    ...
    */
    private void display_info(String json, int position, ListView lv) throws JSONException{
        ...
        lv.setAlpha(0);
        lv.setEnabled(false);
        ConstraintLayout ActivitiesBanner = findViewById(R.id.activitiesBanner);
        ActivitiesBanner.setAlpha(.2f);
        ...
        closeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ListView lv = findViewById(R.id.activities_list);
                lv.setAlpha(1);
                lv.setEnabled(true);

                ConstraintLayout ActivitiesBanner = findViewById(R.id.activitiesBanner);
                ActivitiesBanner.setAlpha(1);
                ConstraintLayout DetailsLayout = findViewById(R.id.details);
