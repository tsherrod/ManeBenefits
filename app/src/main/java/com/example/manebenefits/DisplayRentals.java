...
public class DisplayRentals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.display_rentals);

        // List of Rental Businesses
        listView = (ListView) findViewById(R.id.rentals_list);
        listView.setBackgroundColor(getResources().getColor(R.color.lightPurple));
        listView.bringToFront();

        // Menu
        menu_lv = findViewById(R.id.menu_lv);
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(DisplayRentals.this,
        ...
        menu_lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    case 0:
                        startActivity(new Intent(DisplayRentals.this, MainActivity.class));
                        break;
                    case 1:
                        startActivity(new Intent(DisplayRentals.this, Categories.class));
                        break;
                    case 3:
                        startActivity(new Intent (DisplayRentals.this, ViewCard.class));
                        break;
                }
            }
        });
        ...
        // Call to getRentals.php
        // IP string stored in app/res/values/strings.xml
        downloadJSON("http://" + getResources().getString(R.string.IP) +"/" + getResources().getString(R.string.AppFolder)+ "/getRentals.php");
    }
    ...
    */
    private void display_info(String json, int position, ListView lv) throws JSONException{
        // Begin by setting the transparency for the rentals list and the banner to invisible
        // Display the details in separate layout
        lv.setAlpha(0);
        lv.setEnabled(false);
        ConstraintLayout RentalsBanner = findViewById(R.id.rentalsBanner);
        RentalsBanner.setAlpha(.2f);
        ...
        closeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ListView lv = findViewById(R.id.rentals_list);
                lv.setAlpha(1);
                lv.setEnabled(true);

                ConstraintLayout RentalsBanner = findViewById(R.id.rentalsBanner);
                RentalsBanner.setAlpha(1);
                ConstraintLayout DetailsLayout = findViewById(R.id.details);
